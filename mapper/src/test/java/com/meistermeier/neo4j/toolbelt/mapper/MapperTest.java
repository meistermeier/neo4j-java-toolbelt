...
class MapperTest {
	...
	class RecordMapping {
		...
		void convertMapFieldToRecord() {
			MapAccessor record = Values.value(Map.of("d", Map.of("something", "d1")));
		...
		void ignoreUnknownValues() {
			MapAccessor record = Values.value(Map.of("aa", "a", "bb", "b", "cc", Values.value("a", "b", "c"), "dd", Map.of("something", "d1")));
